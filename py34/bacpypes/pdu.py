...
class ARCNETAddress(Address):
    ...
    def __str__(self):
        ...
        return prefix + str(self.addrAddr[0])
        ...
        if isinstance(addr, int):
            ...
            while True:
                ...
                if interface_port_match:
                    ...
                    ipaddress.IPv4Interface.__init__(self, ipv4_address['addr'] + '/' + ipv4_address['netmask'])
        ...
        if isinstance(addr, int):
            ...
            while True:
                ...
                if interface_port_match:
                    ...
                    ipaddress.IPv6Interface.__init__(self, addr + netmask)
                    break
